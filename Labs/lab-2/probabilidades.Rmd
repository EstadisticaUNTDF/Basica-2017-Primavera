...
una racha de 1? ¿Cuántos en una racha de longitud 0?
...
Simular un jugador de básquet que dispara independientemente usa el mismo
...
-   Usando `calc_racha`, calculen la longitud de las rachas de `sim_basket`, y
    ...
    frame no necesitamos primero seleccionar primero el data frame como hicimos
...
-   Si fueses a correr la simulación del tirador independiente una segunda vez,
    ¿Cómo esperarías que su destrucción de rachas se compare con la distribución
